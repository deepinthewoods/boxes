...
class SpeakerGrille(Boxes):
    ...
    def hexHoles(self):
        hexSettings = HexHolesSettings(self.thickness)
        hexSettings.thickness = self.thickness
        hexSettings.absolute_params = False
        self.hexHolesCircle(self.x, hexSettings)
    ...
    def render(self):
        ...
        #                      ignore_widths=[1, 6], move="up")
        self.parts.disc(x, callback=self.hexHoles, move="up")
